...
$(document).ready(function(){
  ...
  // set your custom ID (#bootstrap3 is the ID) then, refer to index.html, find the menu, it should be match this ID
	...
	txt +='<link rel="stylesheet" href="modules/bootstrap/v3/css/bootstrap.min.css" />' + "\n";
  txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +='<script src="modules/bootstrap/v3/js/bootstrap.min.js"></script>' + "\n";
  ...
  // End bootstrap library
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/bootstrap/dist/css/bootstrap.min.css\""+" />"+"\n";
	txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/bootstrap/dist/js/bootstrap.min.js\">"+"</"+"script"+">";
	appendJSLib(txt);  });

	// normalize.css
	$("#normalizecss").click(function() {
	txt ="   <"+"link rel=\"stylesheet\" href=\"modules/normalizecss/normalize.css\""+"/>";
	appendJSLib(txt);  });

  // fontawesome.css
	$("#fontawesome").click(function() {
	txt ="   <"+"link rel=\"stylesheet\" href=\"modules/font-awesome/css/font-awesome.min.css\""+"/>";
	appendJSLib(txt);  });
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
  txt +="  <"+"link rel=\"stylesheet\" href=\"modules/uikit/v2/css/uikit.min.css\""+" />"+"\n";
	txt +="  <"+"script src=\"modules/jquery/jquery-1.12.4.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/uikit/v2/js/uikit.min.js\">"+"</"+"script"+">"+"\n";
	appendJSLib(txt);  });
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
  txt +="  <"+"link rel=\"stylesheet\" href=\"modules/uikit/v3/css/uikit.min.css\""+" />"+"\n";
	txt +="  <"+"script src=\"modules/jquery/jquery-3.2.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/uikit/v3/js/uikit.min.js\">"+"</"+"script"+">"+"\n";
	appendJSLib(txt);  });
  ...
  // foundation
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/foundation-sites/dist/css/foundation.min.css\""+" />"+"\n";
	txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/foundation-sites/dist/js/foundation.min.js\">"+"</"+"script"+">";
	appendJSLib(txt);  });
  ...
  // Bulma
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/bulma/css/bulma.css\""+" />"+"\n";
	appendJSLib(txt);  });
  ...
  // materialize
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/materialize-css/dist/css/materialize.min.css\""+" />"+"\n";
  txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/materialize-css/dist/js/materialize.min.js\">"+"</"+"script"+">";
	appendJSLib(txt);  });
  ...
  // Semantic UI
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/semantic-ui/dist/semantic.min.css\""+" />"+"\n";
  txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/semantic-ui/dist/semantic.min.js\">"+"</"+"script"+">";
	appendJSLib(txt);  });
	...
	txt ="  <"+"meta charset=\"utf-8\""+" />"+"\n";
	txt +="  <"+"meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\""+" />"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/material-design-lite/dist/material.min.css\""+"/>"+"\n";
  txt +="  <"+"script src=\"modules/material-design-lite/dist/material.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"link rel=\"stylesheet\" href=\"modules/material-design-lite/dist/material-icons.css\""+"/>";
	appendJSLib(txt);  });
  ...
  // v 2x
	...
	txt ="  <"+"script src=\"modules/jquery/jquery-2.2.4.min.js\">"+"</"+"script"+">"+"\n";
	appendJSLib(txt);  });
  // v 3x
  ...
  $("#jqueryui").click(function() {
 	txt ="  <"+"link rel=\"stylesheet\" href=\"modules/jquery-ui/jquery-ui.min.css\""+"/>"+"\n";
	txt +="  <"+"script src=\"modules/jquery/jquery-3.3.1.min.js\">"+"</"+"script"+">"+"\n";
	txt +="  <"+"script src=\"modules/jquery-ui/jquery-ui.min.js\">"+"</"+"script"+">"+"\n";
	appendJSLib(txt);  });

  // MooTools
    $("#MooTools").click(function() {
	txt ="  <"+"script src=\"modules/mootools/MooTools.js\">"+"</"+"script"+">"+"\n";
	appendJSLib(txt);  });
  ...
  $('#insert-img-src').click(function() {
  	codeeditorhtml.replaceSelection("<img src=\"media/img/bg.jpg\" width=\"1024\" height=\"455\" alt=\"Example Image\" />");
  });
  $('#insert-anchor-tag').click(function() {
  	codeeditorhtml.replaceSelection('<a title="Home" href="https://html-css-js.com" target="_blank">Link</a> ');
  });
  $('#insert-table-tag').click(function() {
  	codeeditorhtml.replaceSelection('<table border="1">\n<tbody><tr>\n<td>&nbsp;</td>\n<td>&nbsp;</td>\n<td>&nbsp;</td>\n</tr>\n<tr>\n<td>&nbsp;</td>\n<td>&nbsp;</td>\n<td>&nbsp;</td>\n</tr>\n</tbody>\n</table>');
  });
  $('#insert-iframe-tag').click(function() {
  	codeeditorhtml.replaceSelection('<iframe style="width: 100%; height: 100px; overflow: hidden;" src="https://html-css-js.com/" width="100" height="100" scrolling="no">Iframes not supported</iframe>');
  });
