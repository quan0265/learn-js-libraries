...
EPUBJS.Book = function(options){
	...
	this.settings = EPUBJS.core.defaults(options || {}, {
		...
		storage: true, //-- true (auto) or false (none) | override: 'ram', 'websqldatabase', 'indexeddb', 'filesystem'
		fromStorage : false,
		saved : false,
		online : true,
		contained : false,
...
EPUBJS.Renderer.prototype.pagesInCurrentChapter = function() {
	...
	if(!this.pageMap) {
		console.log("page map not loaded");
		return false;
	}
...
EPUBJS.Renderer.prototype.getVisibleRangeCfi = function(){
	...
	if(!startRange) {
		console.log("page range miss:", pg, this.pageMap);
